...
export default function SynthesizerConfigTab({ config, setConfig }: Props) {
    const synth =
        config?.agent_config?.tasks?.[0]?.tools_config?.synthesizer || {
            provider: "elevenlabs",
            provider_config: {
                voice: "George",
            ...
            <section className="bg-white border rounded-md p-4 space-y-4">
                ...
                <div className="flex gap-3 items-center">
                    <select
                        ...
                        onChange={(e) =>
                            update("agent_config.tasks.0.tools_config.synthesizer.provider_config.voice", e.target.value)
                        }
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                update("agent_config.tasks.0.tools_config.synthesizer.provider_config.model", e.target.value)
                            }
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => update("agent_config.tasks.0.tools_config.synthesizer.audio_format", e.target.value)}
                            className="w-full border rounded px-3 py-2"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                update("agent_config.tasks.0.tools_config.synthesizer.sampling_rate", parseInt(e.target.value))
                            }
                            className="w-full border rounded px-3 py-2"
                        />
                    </div>
                    ...
                    <div className="col-span-2 flex items-center gap-2">
                        <input
                            ...
                            onChange={(e) => update("agent_config.tasks.0.tools_config.synthesizer.stream", e.target.checked)}
                        />
                    ...
                    <div className="col-span-2 flex items-center gap-2">
                        <input
                            ...
                            onChange={(e) => update("agent_config.tasks.0.tools_config.synthesizer.caching", e.target.checked)}
                        />
                    ...
                    <div >
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                update("agent_config.tasks.0.tools_config.synthesizer.buffer_size", parseInt(e.target.value))
                            }
                            className="w-full border rounded px-3 py-2"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                update("agent_config.tasks.0.tools_config.synthesizer.provider_config.use_mulaw", e.target.checked)
                            }
                            className="w-full border rounded px-3 py-2"
                        />
                    </div>
