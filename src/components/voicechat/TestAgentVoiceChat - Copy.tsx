...
export default function TestAgentVoiceChat({ agentId }: { agentId: string }) {
  ...
  return (
    <div className="p-4 max-w-md mx-auto bg-white rounded shadow space-y-6">
      <h2 className="text-xl font-bold">Test Agent Voice Chat</h2>
